...
ui <- fluidPage(
  titlePanel("Data Vizualization Tool"),
  br(),
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      selectInput("separator", "Please Specify Data Separator:",
                  c(Comma = ",",BlankSpace = "\t",Semicolon = ";")),
      
      fileInput(inputId = "Data", label = "Please choose File (csv or txt):", multiple = F),
